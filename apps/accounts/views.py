...
from .serializers import RegisterSerializer,LoginSerializer,ProfileSerealizers,ProfileUpdateSerealizers,VirfiyPasswordSerialezers,UserListSerializer,ForgotPasswordSerealizers , UserListAdminSerailizirs
...
class RegisterView(GenericAPIView):
    ...
    def post(self, request):
        ...
        return Response({
                ...
                'user': ProfileSerealizers(user).data},status=status.HTTP_201_CREATED)
...
@extend_schema(tags=["Auth - Register - Login - OTP"],
               ...
               Bu endpoint quyidagi amallarni bajaradi:
                ...
                - Passwordni unutgan bulasnigiz unutdimni bosing.
               """) 
...
@extend_schema(tags=["Profile - Crud"],
               summary="My Profile",
               description="""
               Barcha malumotlarningizni kurung.
               """)
...
@extend_schema(tags=["Profile - Crud"],
               ...
               description="""
               Barcha malumotlarningizni yangilang.
               """)
...
@extend_schema(tags=["I forgot my password."],
